...
insert into `image_category` values (2, '资质证书', 0, '/root/trace/static/upload', 'http://www.tiaocaishi.com:9527/resources', '');
insert into `image_category` values (3, '蔬菜种植', 0, '/root/trace/static/upload', 'http://www.tiaocaishi.com:9527/resources', '存储蔬菜相关的图片');
insert into `image_category` values (10, '其他', 0, '/root/trace/static/upload', 'http://www.tiaocaishi.com:9527/resources', '');

insert into `image_category` values (11, '质检报告', 1, 'c:/trace/static/upload', 'http://localhost:8080/resources', '');
insert into `image_category` values (12, '资质证书', 1, 'c:/trace/static/upload', 'http://localhost:8080/resources', '');
insert into `image_category` values (13, '蔬菜种植', 1, 'c:/trace/static/upload', 'http://localhost:8080/resources', '存储蔬菜相关的图片');
insert into `image_category` values (20, '其他', 1, 'c:/trace/static/upload', 'http://localhost:8080/resources', '');
